...
const products = [
  {
    ...
    price: 15000,
    format: 'both',
    physicalBook: { stock: 50, weight: 0.5, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '2.1 MB', previewPages: 10 },
    language: 'English',
    pages: 180,
    publisher: 'Scribner',
    publishedYear: 1925,
  ...
  },
  {
    ...
    discountPrice: 13500,
    format: 'both',
    physicalBook: { stock: 40, weight: 0.55, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '1.8 MB', previewPages: 15 },
    language: 'English',
    pages: 281,
  ...
  },
  {
    ...
    price: 14000,
    format: 'both',
    physicalBook: { stock: 60, weight: 0.45, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '1.5 MB', previewPages: 12 },
    language: 'English',
    pages: 328,
    publisher: 'Signet',
    publishedYear: 1949,
  ...
  },
  {
    ...
    discountPrice: 38000,
    format: 'both',
    physicalBook: { stock: 30, weight: 0.8, shippingCost: 2500 },
    ebook: { fileUrl: null, fileSize: '5.2 MB', previewPages: 20 },
    language: 'English',
    pages: 464,
  ...
  },
  {
    ...
    price: 42000,
    format: 'physical',
    physicalBook: { stock: 25, weight: 0.6, shippingCost: 2000 },
    language: 'English',
    pages: 352,
  ...
  {
    title: 'Ikinyarwanda Cy\'umwana',
    author: 'Rwandan Authors Collective',
    isbn: '9789997700101',
    ...
    price: 8000,
    format: 'physical',
    physicalBook: { stock: 100, weight: 0.2, shippingCost: 1500 },
    language: 'none',
    pages: 48,
    publisher: 'Rwanda Publishing House',
    publishedYear: 2022,
    tags: ['children', 'kinyarwanda', 'education'],
    newArrival: true,
    ratingsAverage: 4.8,
    ratingsCount: 45,
    salesCount: 320,
  },
  {
    ...
    discountPrice: 12000,
    format: 'both',
    physicalBook: { stock: 80, weight: 0.35, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '1.2 MB', previewPages: 8 },
    language: 'English',
    pages: 197,
    publisher: 'HarperOne',
    publishedYear: 1988,
    tags: ['inspirational', 'philosophy', 'adventure'],
    featured: true,
    bestSeller: true,
    ratingsAverage: 4.7,
    ratingsCount: 3200,
  ...
  },
  {
    ...
    price: 32000,
    format: 'both',
    physicalBook: { stock: 45, weight: 0.7, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '4.8 MB', previewPages: 18 },
    language: 'English',
    pages: 443,
    publisher: 'Harper',
    publishedYear: 2015,
  ...
  },
  {
    ...
    price: 18000,
    format: 'physical',
    physicalBook: { stock: 70, weight: 0.4, shippingCost: 2000 },
    language: 'English',
    pages: 233,
    publisher: 'TarcherPerigee',
    publishedYear: 1937,
    tags: ['self-help', 'success', 'wealth'],
    featured: true,
    ratingsAverage: 4.3,
    ratingsCount: 1500,
    salesCount: 4500,
  },
  {
    ...
    price: 9500,
    format: 'both',
    physicalBook: { stock: 90, weight: 0.25, shippingCost: 1500 },
    ebook: { fileUrl: null, fileSize: '0.8 MB', previewPages: 5 },
    language: 'English',
    pages: 112,
    publisher: 'Shambhala',
    publishedYear: -500,
  ...
  },
  {
    ...
    discountPrice: 18500,
    format: 'both',
    physicalBook: { stock: 65, weight: 0.5, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '2.5 MB', previewPages: 14 },
    language: 'English',
    pages: 320,
    publisher: 'Avery',
    publishedYear: 2018,
  ...
  },
  {
    ...
    price: 17000,
    format: 'both',
    physicalBook: { stock: 35, weight: 0.9, shippingCost: 2500 },
    ebook: { fileUrl: null, fileSize: '3.1 MB', previewPages: 16 },
    language: 'English',
    pages: 672,
    publisher: 'Vintage',
    publishedYear: 2005,
  ...
  },
  {
    ...
    price: 19000,
    format: 'both',
    physicalBook: { stock: 100, weight: 0.6, shippingCost: 2000 },
    ebook: { fileUrl: null, fileSize: '2.8 MB', previewPages: 12 },
    language: 'English',
    pages: 352,
    publisher: 'Bloomsbury',
    publishedYear: 1997,
    tags: ['fantasy', 'magic', 'adventure', 'children'],
    featured: true,
    bestSeller: true,
    ratingsAverage: 4.9,
    ratingsCount: 5500,
  ...
  },
  {
    ...
    price: 20000,
    format: 'both',
    physicalBook: { stock: 40, weight: 1.0, shippingCost: 2500 },
    ebook: { fileUrl: null, fileSize: '4.2 MB', previewPages: 22 },
    language: 'English',
    pages: 688,
    publisher: 'Ace',
    publishedYear: 1965,
  ...
  },
  {
    ...
    discountPrice: 23500,
    format: 'physical',
    physicalBook: { stock: 20, weight: 0.55, shippingCost: 2000 },
    language: 'English',
    pages: 336,
...
const seed = async () => {
  try {
    ...
    const productDocs = products.map((p, i) => {
      ...
      return { ...p, category: catMap[catName], coverImage: `https://picsum.photos/seed/${slug}/400/600` };
    });
    ...
    for (let i = 0; i < createdProducts.length; i++) {
      ...
      for (let j = 0; j < shuffled.length && added < numReviews; j++) {
        const key = `${shuffled[j]._id}:${createdProducts[i]._id}`;
    ...
    for (let i = 0; i < 12; i++) {
      ...
      for (let j = 0; j < numItems; j++) {
        ...
        items.push({
          ...
          coverImage: `https://picsum.photos/seed/${product.title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')}/400/600`,
    ...
    for (const user of customerUsers) {
      ...
      const products = shuffled.slice(0, numProducts).map(p => ({
        product: p._id,
        addedAt: formatDate(randomInt(1, 30)),
      }));
      wishlistDocs.push({ user: user._id, products });
    }
    const createdWishlists = await Wishlist.insertMany(wishlistDocs);
    console.log(`  ${createdWishlists.length} wishlists created`);

    console.log('\n--- Seed Summary ---');
    console.log(`Categories: ${createdCategories.length}`);
    console.log(`Users: ${createdUsers.length} (${adminUser.email} — admin)`);
