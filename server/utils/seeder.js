...
const products = [
  ...
  { title: '1984', author: 'George Orwell', isbn: '9780451524935', description: 'A dystopian novel set in a totalitarian society ruled by Big Brother, exploring surveillance, propaganda, and the erosion of truth.', price: 14000, format: 'both', physicalBook: { stock: 60, weight: 0.45, shippingCost: 2000 }, ebook: { fileUrl: null, fileSize: '1.5 MB', previewPages: 12 }, language: 'English', pages: 328, publisher: 'Signet', publishedYear: 1949, tags: ['dystopian', 'classic', 'science-fiction'], featured: true, bestSeller: true, newArrival: false, ratingsAverage: 4.5, ratingsCount: 1890, salesCount: 4200 },
