  ...
  return (
    <div className="min-h-screen page-bg pt-24 pb-20">
      <div className="section-container">
        ...
        <div className="mb-8">
          <Link to="/books" className="inline-flex items-center gap-2 text-primary hover:text-primary-dim font-medium mb-4">
        ...
        {items.length === 0 ? (
          <div className="glass-dark p-12 rounded-lg flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
            <div className="w-24 h-24 bg-neutral-low rounded-full flex items-center justify-center mb-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 space-y-4">
              {items.map((item) => (
                <div key={item.product._id} className="glass-dark p-4 sm:p-6 rounded-lg flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="flex justify-between items-start gap-4 mb-2">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <span className="text-[10px] uppercase font-bold text-outline bg-neutral-low px-2 py-1 rounded border border-neutral-high">
                        ...
                        {item.product.format === 'both' && (
                          <button
                            ...
                            className="text-[10px] uppercase font-bold text-primary hover:text-primary-dim bg-primary/10 px-2 py-1 rounded border border-primary/30 transition-colors"
                          >
                    ...
                    <div className="flex items-center gap-4 mt-auto pt-4 border-t border-neutral-low/50">
                      ...
                      <button
                        ...
                        className="p-2 text-surface-500 hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-colors ml-2"
                      >
            ...
            <div className="w-full lg:w-96 shrink-0">
              <div className="glass-dark p-6 rounded-lg sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="pt-4 border-t border-neutral-low">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-3xl font-bold text-primary">RWF {total().toLocaleString()}</span>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="btn-primary w-full flex items-center justify-center gap-2 h-[56px] text-lg"
                >
